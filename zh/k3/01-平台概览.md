...
<div style="display: flex; gap: 8ch; align-items: flex-start;">
  <figure style="flex: 1; margin: 0;">
    <img src="https://cdn-resource.spacemit.com/file/product/K3/assets/robot_nav2.gif" alt="robot_nav2" style="width: 100%; aspect-ratio: 4 / 3; object-fit: contain; display: block;" />
    <figcaption style="text-align: center; margin-top: 0.5rem;">轮式机器人巡航</figcaption>
  </figure>
  <figure style="flex: 1; margin: 0;">
    <img src="https://cdn-resource.spacemit.com/file/product/K3/assets/lerobot.gif" alt="lerobot" style="width: 100%; aspect-ratio: 4 / 3; object-fit: contain; display: block;" />
    <figcaption style="text-align: center; margin-top: 0.5rem;">机械臂搬运</figcaption>
  </figure>
</div>
<div style="display: flex; gap: 8ch; align-items: flex-start; margin-top: 1rem;">
  <figure style="flex: 1; margin: 0;">
    <img src="https://cdn-resource.spacemit.com/file/product/K3/assets/fsm_demo.gif" alt="fsm_demo" style="width: 100%; aspect-ratio: 4 / 3; object-fit: contain; display: block;" />
    <figcaption style="text-align: center; margin-top: 0.5rem;">人型机器跳舞</figcaption>
  </figure>
  <figure style="flex: 1; margin: 0;">
    <img src="https://cdn-resource.spacemit.com/file/product/K3/assets/reachy_mini.gif" alt="reachy_mini" style="width: 100%; aspect-ratio: 4 / 3; object-fit: contain; display: block;" />
    <figcaption style="text-align: center; margin-top: 0.5rem;">reachy mini语音控制</figcaption>
  </figure>
</div>
...
- **系统与平台层**：系统服务、驱动、外设与多媒体能力（见 `06-系统与平台/`）
- **组件能力层**：模型/推理/语音等可复用组件与服务（见 `04-AI能力/`）
- **ROS2机器人中间层**：感知、控制、SLAM、导航、规划等功能包（见 `05-机器人开发/`）
- **应用与方案层**：端到端应用与整机参考实现（见 `03-参考方案/`）
