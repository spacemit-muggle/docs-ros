...
<div style="display:grid; grid-template-columns: repeat(2, minmax(0, 1fr)); column-gap: 0px; row-gap: 12px; align-items: start; margin-top: 12px;">
  <div style="min-width: 0;">
    <img src="https://cdn-resource.spacemit.com/file/product/K3/assets/fsm_demo.gif" alt="fsm_demo" style="width: 100%; height: 260px; object-fit: contain; display: block;" />
  ...
  <div style="min-width: 0;">
    ...
    <div style="text-align:center; margin-top: 0.5em;">reachy mini语音控制</div>
  </div>
</div>
